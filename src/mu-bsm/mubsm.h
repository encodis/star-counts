/*
  ...
  History  : Began: 23 May 1991. Last edit: 3 August 1994.
...
typedef struct param {
  REAL mag;               /* THE magnitude!                                 */
  REAL mu_brt;            /* brightest app. mag. for calculation            */
  REAL mu_dim;            /* dimmest app. mag. for calculation              */
  REAL del_mu;            /* app. mag. bin size                             */
  ...
  REAL mturn;             /* turn-off mag. for SPH gb & m-s                 */
...
typedef struct model {
  ...
  char dmsfn[MAXFCH];     /* Main Sequence (dwarf) filename (eg mainseq.cm) */ 
...
typedef struct color {
  ...
  REAL *sms;              /* Spheroid Sequence colour distn.                */
...
extern void calc_dsk(Param *, Lumfn *, Model *, Color *, Numbr *);
extern void calc_num(BOOL, Param *, Numbr *);
extern void calc_sph(Param *, Lumfn *, Model *, Color *, Numbr *);
extern void calc_thk(Param *, Lumfn *, Model *, Color *, Numbr *);
extern void col_dist(int, REAL, REAL, REAL, REAL, REAL, Param *, Numbr *);
...
extern void init_num(Param *, Model *, Numbr *);
...
extern REAL solve4r(Param *, Model *, REAL);
...
extern void writ_vrb(BOOL, Param *, Model *, Lumfn *, Color *, Numbr *, 
		     FILE *);
extern REAL zbrent(Param *, Model *, REAL, REAL);
/*---------------------------------------------------------------------------*/
