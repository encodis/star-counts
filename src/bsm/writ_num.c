...
void writ_num(BOOL thick, Param *pm, Model *ml, Numbr *nm, FILE *out)
{
  ...
  if (thick == TRUE) {
    ...
    fprintf(out,"# %s1    %s     %s2    Ad(%s)    Nd(<%s2)    At(%s)    Nt(<%s2)\n", 
    ...
    fprintf(out,"# %s1    %s     %s2    As(%s)    Ns(<%s2)    AT(%s)    NT(<%s2)\n",
	    ml->mag, ml->mag, ml->mag, ml->mag, ml->mag, ml->mag, ml->mag);
    ...
    fprintf(out,"# %s1    %s     %s2    Ad(%s)    Nd(<%s2)    As(%s)    Ns(<%s2)    AT(%s)    NT(<%s2)\n",
	    ml->mag, ml->mag, ml->mag, ml->mag, ml->mag, ml->mag, ml->mag, ml->mag, ml->mag);
