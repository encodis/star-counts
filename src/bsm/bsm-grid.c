/*
   Program : bsm-grid
   Function: Bahcall - Soneira Model.
             Run models over 2-D parameter grid.
   History : Began: 2 March 1995.
   Author  : P.J.C.Hodder (hodder@geop.ubc.ca)
   Usage   : bsm-grid pref pfile p1 min1 max1 del1 p2 min2 max2 del2
...
#define TRUE  1
#define FALSE 0
#define USAGE fprintf(stderr,"Usage: bsm-grid [-t] prefix pfile par1 min1 max1 del1 [par2 min2 max2 del2]\n")
...
void main(int argc, char **argv)
{
  ...
  if (s == TRUE) {
	...
	strcpy(cmd,"bsm "); strcat(cmd,file); strcat(cmd," ");
