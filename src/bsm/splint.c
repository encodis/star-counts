/*
  ...
  History  : Began modification: 22 November 1991. Last edit: 30 June 1994.
  ...
  Comments : 1. Original code from Numerical Recipes in C (Press, Flannery, 
	     ...
	     2. Modified by PJCH to avoid use of other NR constructs and 
	        functions.
	     3. Function returns the value of y directly rather than through 
	        an address. This fits better with the way it is used in 
		init_col() and init_lum().
*/
