/* 
   ...
   Purpose  : Bahcall - Soneira Galaxy Model. 
              Initialize and compute luminosity functions.
   History  : Began: 30 May 1991. Last edit: 30 June 1994.
   Author   : P.J.C.Hodder (hodder@geop.ubc.ca)
   Comments : 1. The input LF on disk is "M log10(N)". This make the spline
                 fitting easier due to the smaller gradients. The antilog is
		 taken after the spline fitting is done.
*/
